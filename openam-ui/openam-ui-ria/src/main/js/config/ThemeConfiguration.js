...
define({
    themes: {
        ...
        "default": {
            ...
            // An optional ordered list of URLs to stylesheets that will be applied to every admin page of the XUI.
            // The entries will be appended to the list of default stylesheets.
            //adminStylesheets: [],
